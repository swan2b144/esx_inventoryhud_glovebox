Locales["fr"] = {
  ["glovebox_closed"] = "Ce coffre est fermé.",
  ["no_veh_nearby"] = "Il n'y a pas de véhicule près de vous.",
  ["glovebox_in_use"] = "Ce coffre est en cours d'utilisation.",
  ["glovebox_full"] = "Ce coffre est plein.",
  ...
  ["glovebox_info"] = "<h3>Coffre de véhicule</h3><br><strong>Plaque:</strong> %s<br><strong>Capacité:</strong> %s / %s",
